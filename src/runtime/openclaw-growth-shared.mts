...
export function buildOpenClawGrowthSystemEvent(configPath, config = {}) {
  ...
  return [
    ...
    'For ASC Sales and Trends vendor setup, ASC_VENDOR_NUMBER is the canonical required variable. ASC_ANALYTICS_VENDOR_NUMBER is only a backward-compatible alias; never list it as a separate missing requirement.',
